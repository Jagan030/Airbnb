...
st.set_page_config(page_title= "Airbnb Data Visualization | By Jagan",
                
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This dashboard app is created by *Jagan*!
...
client = pymongo.MongoClient("mongodb+srv://jags8111:jagan1998@cluster0.iiemb1k.mongodb.net/?retryWrites=true&w=majority")
